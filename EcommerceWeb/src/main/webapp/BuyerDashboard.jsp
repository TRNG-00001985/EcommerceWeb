...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #e1bee7, #ce93d8); /* Gradient background with purple tones */
            font-family: Arial, sans-serif;
        }
        .navbar {
            background-color: #6a1b9a; /* Dark purple for the navbar */
        }
        .navbar-brand {
        ...
        .navbar-nav .nav-link:hover {
            color: #d1c4e9 !important; /* Light purple on hover */
        }
        .container {
            margin-top: 30px;
            padding: 30px;
        ...
        .card-header {
            background-color: #6a1b9a; /* Dark purple for the card header */
            color: white; /* White text color */
            font-weight: bold;
        }
        .btn-primary {
            background-color: #6a1b9a; /* Matching button color */
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <a href="Buyerprofile.jsp" class="btn btn-primary">Edit Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
