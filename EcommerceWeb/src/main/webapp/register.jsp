...
<head>
    ...
    <style>
        body {
            background-color: #f3e5f5; /* Light purple background for the page */
        }
        .container {
            background-color: #e1bee7; /* Light purple background for the main container */
            padding: 20px;
        ...
        .card-header {
            background-color: #9c27b0; /* Purple for the header */
        ...
        .page-header {
            text-align: center;
            margin-top: 20px;
            color: #9c27b0; /* Purple color for the heading */
        }
    </style>
</head>
<body>
