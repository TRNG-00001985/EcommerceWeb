...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #f3e5f5, #e1bee7); /* Gradient background */
            font-family: Arial, sans-serif;
        }
        .navbar {
            background-color: #9c27b0; /* Purple for the navbar */
        }
        .navbar-brand {
        ...
        .card-header {
            background-color: #9c27b0; /* Purple for the card header */
...
<nav class="navbar navbar-expand-lg navbar-dark">
    <a class="navbar-brand" href="#">RevShop Seller Dashboard</a>
