...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #f3e5f5, #ce93d8); /* Light purple gradient background */
        ...
        .card-header {
            background-color: #8e24aa; /* Darker purple for the card header */
            color: white;
            font-weight: bold;
        }
        .btn-primary {
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">This is a brief description of Category 1.</p>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">This is a brief description of Category 2.</p>
                    <a href="#" class="btn btn-primary">View Products</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">This is a brief description of Category 3.</p>
                    <a href="#" class="btn btn-primary">View Products</a>
                </div>
            </div>
        </div>
